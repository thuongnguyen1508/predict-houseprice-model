...
#                       Final Prediction                              #
#######################                         #######################
preds_on_trained = loaded_model.predict(X_test)
...
print("DISPLAY CHART");
price_on_trained = [convert_label_value(y[0]) for y in preds_on_trained]
actual_price = [convert_label_value(y) for y in y_train]

drawChart(actual_price, price_on_trained, price_on_trained, 50)
